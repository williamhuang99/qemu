...
DEF("cpu-prop", HAS_ARG, QEMU_OPTION_cpu_prop,
    "-cpu-prop pctrace=on|off[,elrw=on|off]\n"
    "                [,mem_prot=mmu|mgu|no][,full_mmu=on|off]\n"
    "                [,unaligned_access=on|off]\n"
    "                set CSKY CPU's properties\n"
    "                pctrace= default is off, log no more than 511 items\n"
    "                elrw= default is off\n"
    "                mem_prot= ck610/ck807/ck810/ck860 default is mmu, else mgu\n"
    "                full_mmu= default is off\n"
    "                unaligned_access= default is off\n"
    , QEMU_ARCH_CSKY)
STEXI
@item -cpu-prop pctrace=on|off[,elrw=on|off][,mem_prot=mmu|mgu|no][,full_mmu=on|off][,unaligned_access=on|off]
@findex -cpu-prop
...
@table @option
@item pctrace=on|off
This option defines if need to record pctrace, default is off. The number of pctrace is no more than 511.
@item elrw=on|off
This option defines if has elrw extend.
@item mem_prot=mmu|mgu|no
This option defines if need to select memory protect unit.
@item full_mmu=on|off
...
DEF("csky-extend", HAS_ARG, QEMU_OPTION_csky_extend,
    "-csky-extend vdsp=vdsp[,exit_addr=addr][,mem_default=on|off][,tb_trace=on|off][,denormal=on|off][,cpu_freq=@var{cpu_freq}][,hbreak=on|off]\n"
    ...
    , QEMU_ARCH_CSKY)
STEXI
@item -csky-extend vdsp=@var{vdsp}[,exit_addr=@var{addr}][,mmu_default=on|off][,tb_trace=on|off][,denormal=on|off][,cpu_freq=@var{cpu_freq}][,hbreak=on|off]
@findex -csky-extend
...
DEF("csky-trace", HAS_ARG, QEMU_OPTION_csky_trace,
    "-csky-trace port=port[,tb_trace=on|off][,mem_trace=on|off]\n"
    ...
    , QEMU_ARCH_CSKY | QEMU_ARCH_RISCV)
STEXI
@item -csky-trace port=@var{port}[,tb_trace=on|off][,mem_trace=on|off][,auto_trace=on|off]
@findex -csky-trace
