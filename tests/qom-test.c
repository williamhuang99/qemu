...
static const char *blacklist_csky0[] = {
    "dummyh", "dummyh", NULL
};

static const char *blacklist_csky1[] = {
    "virt", "virt", NULL
};
...
static const struct {
    ...
    { "cskyv2", blacklist_csky0 },
    { "cskyv2eb", blacklist_csky0 },
    { "cskyv1", blacklist_csky0 },
    { "cskyv1eb", blacklist_csky0 },
    { "cskyv2", blacklist_csky1 },
    { "cskyv2eb", blacklist_csky1 },
    { "cskyv1", blacklist_csky1 },
    { "cskyv1eb", blacklist_csky1 },
};
